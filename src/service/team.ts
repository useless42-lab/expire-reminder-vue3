...
const teamApi = {
    ...
    // 退出团队
    ExitTeamService(data: any){
        return request({
            url:`v1/user/team/member/exit`,
            method:"post",
            data:data,
        })
    },
    GetOverviewTeamService(){
        return request({
            url:`v1/user/overview/list`,
            method:"get",
        })
    },
    SearchOverviewService(data: any){
        return request({
            url:`v1/user/overview/search`,
            method:"post",
            data:data,
        })
    }
